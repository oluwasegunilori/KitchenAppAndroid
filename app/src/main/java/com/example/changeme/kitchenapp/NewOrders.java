 ...
 * {@link NewOrders.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link NewOrders#newInstance} factory method to
...
public class NewOrders extends Fragment {
    ...
    private OngoingOrders.OnFragmentInteractionListener mListener;
    ...
    private void loadOrders(String phone) {
        ...
        if (Common.isConnectedToInternet(getContext())) {
            ...
            final Query orderVyUser = requests.orderByChild("phoneplusstatus").equalTo(phone+"_0");
        ...
        if(Common.isConnectedToInternet(getContext())){
            requests.child(key)
                ...
                public void onSuccess(Void aVoid) {
                    ...
                    Toast.makeText(getContext(), new StringBuilder("Order ").append(key)
